/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c220f97abf771fcaab8fe24be2a7d389)
// Runtime types generated with workerd@1.20260301.1 2025-03-01 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TranscriptionSession";
	}
	interface Env {
		MEETINGS: R2Bucket;
		AI: Ai;
		STT_MODEL: "@cf/openai/whisper-large-v3-turbo";
		FORMAT_MODEL: "@cf/google/gemma-3-12b-it";
		MEETING_STT_MODEL: "@cf/deepgram/nova-3";
		MEETING_ENRICH_MODEL: "@cf/meta/llama-3.3-70b-instruct-fp8-fast";
